...
| --- | ------------- | ------- | ----------- |
| MYSQL\_ROOT\_PASSWORD | [mysqld-credentials](/.github/mysqld-credentials.md)  | myrootpassword | By default, the root password is randomly generated. You can specify a specific root password if required. |
