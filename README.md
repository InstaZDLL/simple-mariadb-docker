...
| --- | ------------- | ------- | ----------- |
| MYSQL\_ROOT\_PASSWORD | mysqld-credentials.txt | myrootpassword | By default, the root password is randomly generated. You can specify a specific root password if required. |
